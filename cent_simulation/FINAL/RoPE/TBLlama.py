...
class TransformerBlockLlama(TransformerBlock):
    ...
    def trace_only(self):
        ...
        if self.trace_fc_kqvo:
            ...
            self.rd_k_burst=self.COPYGB_EWMUL_input_only_trace(channels_required, input_vector_EWMUL_utilized_banks, 0, self.xq_row_index, input_vector_EWMUL_length // self.n_repeat * 2)
            ...
            self.ewmul_q_burst=len(channel_lst)*self.dim // self.burst_length
            self.EWMUL_only_trace(channel_lst, self.xk_row_index, self.dim  // self.n_repeat // self.burst_length)
            self.ewmul_k_burst=len(channel_lst)*self.dim // self.n_repeat // self.burst_length
            ...
            self.inv_k_burst=self.COPYGB_EWMUL_input_only_trace(channels_required, input_vector_EWMUL_utilized_banks, 2, self.xq_row_index, input_vector_EWMUL_length // self.n_repeat * 2)
