...
class TransformerBlockLlama(TransformerBlock):
    ...
    def __init__(self, dic_model, args):
        ...
        self.wr_q_burst=0;
        self.store_for_wr_q_burst=0;
        self.wr_k_burst=0;
        self.store_for_wr_k_burst=0;
        self.ewmul_q_burst=0;
        
        self.ewmul_k_burst=0;
        self.rd_q_burst=0;
        self.load_for_rd_q_burst=0;
        self.rd_k_burst =0;
        self.load_for_rd_k_burst=0;
    ...
    def trace_only(self):
        ...
        if self.trace_fc_kqvo:
            ...
            self.apply_rotary_emb_pim_only_trace(channel_lst, channels_required, self.xq_row_index, self.xk_row_index, self.trace_fc_kqvo) #MAINUDDIN 
