...
# Updated Mapping for the 2 setups
...
plt.title('Latency vs Throughput (Llama2-13B, 20 devices)', fontsize=20)
plt.grid(True, linestyle='--', alpha=0.6)

if not os.path.exists("figures"):
    os.mkdir("figures")
plt.savefig('figures/figure_14b_comparison_13B.pdf', bbox_inches='tight')