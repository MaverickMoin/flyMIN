...
for pp in batch[1:]:
    ...
    tp = num_devices // pp
    df = df_simulation_results[(df_simulation_results['Model'] == 'Llama2-70B') & 
                               (df_simulation_results['Device number'] == 32) & 
                               (df_simulation_results['Pipeline parallelism'] == pp) & 
                               (df_simulation_results['Tensor parallelism'] == tp)]
