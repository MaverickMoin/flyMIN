...
df_simulation_results = df_simulation_results[(df_simulation_results['Model'] == "Llama2-70B") & 
                                              (df_simulation_results['Device number'] == 32) & 
                                              (df_simulation_results['Pipeline parallelism'] == transformer_blocks) & 
                                              (df_simulation_results['Tensor parallelism'] == 1)]
