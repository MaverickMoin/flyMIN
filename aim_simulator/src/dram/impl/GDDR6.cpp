        ...
        {"GDDR6_AiM_timing", // name
         {
             ...
             1,    // nWPRE
             32,   // nMODCH
             66+1,   // nRCDRDMINCP MAINUDDIN (changed + 15ns offset)
             500   // tCK_ps
         }},
    };
   ...
   ***********************************************/
    ...
    inline static const ImplLUT m_command_meta = LUT<DRAMCommandMeta>(
        m_commands, {
                        ...
                        {"RDMINCP", {false, false, true, false}}, //MAINUDDIN
    ...
    inline static const ImplLUT m_aim_request_translations = LUT(
        m_aim_requests, m_commands, {
                                        ...
                                        {"ISR_MIN_GB", "RDMINCP"},   // MAINUDDIN 18 - Copy from a bank to the global buffer via MIN
                                        {"MAX", "UNKNOWN"},          // 19 - Unknown and illegal
                                    });
...
private:
    ...
    void set_timing_vals() {
        ...
        m_command_latencies("RDMINCP") = 1; //MAINUDDIN
...
#define V(timing) (m_timing_vals(timing))
        populate_timingcons(this, {
                                      ...
                                      {.level = "channel", .preceding = {"RD", "RDA", "MAC", "MAC16", "RDCP", "RDMINCP", "RDMAC16", "RDAF16"}, .following = {"RD", "RDA", "MAC", "MAC16", "RDCP", "RDMINCP", "RDMAC16", "RDAF16"}, .latency = V("nCCDS")},//MAINUDDIN
                                      {.level = "channel", .preceding = {"WR", "WRA", "WRA16", "WRGB", "WRCP", "WRMAC16"}, .following = {"WR", "WRA", "WRA16", "WRGB", "WRCP", "WRMAC16"}, .latency = V("nCCDS")},//MAINUDDIN
                                      ...
                                      /// RD: RDMAC16, RDAF16, MAC, MAC16, and RDCP
                                      /// WR: WRMAC16, and WRCP
                                      {.level = "channel", .preceding = {"RD", "RDA", "MAC", "RDCP", "RDMINCP", "RDMAC16", "RDAF16", "MAC16", "EWMUL16"}, .following = {"RDMAC16", "RDAF16", "MAC16", "EWMUL16"}, .latency = V("nCCDL")},//MAINUDDIN
                                      {.level = "channel", .preceding = {"RDMAC16", "RDAF16", "MAC16", "EWMUL16"}, .following = {"RD", "RDA", "MAC", "RDCP", "RDMINCP", "RDMAC16", "RDAF16", "MAC16", "EWMUL16"}, .latency = V("nCCDL")},//MAINUDDIN
                                      ...
                                      {.level = "channel", .preceding = {"RD", "RDCP", "RDMINCP", "MAC", "MAC16", "AF16", "EWMUL16"}, .following = {"PREA"}, .latency = V("nRTP")}, //MAINUDDIN
                                      ...
                                      {.level = "channel", .preceding = {"ACT16"}, .following = {"RDMINCP"}, .latency = V("nRCDRDMINCP")}, //MAINUDDIN
                                      ...
                                      {.level = "channel", .preceding = {"TMOD"}, .following = {"ACT", "PREA", "PRE", "RD", "WR", "RDA", "WRA", "REFab", "REFpb", "ACT4", "ACT16", "PRE4", "MAC", "MAC16", "AF16", "EWMUL16", "RDCP", "RDMINCP", "WRCP", "WRGB", "RDMAC16", "RDAF16", "WRMAC16", "WRA16", "SYNC", "EOC"}, .latency = V("nMODCH")},
                                      ...
                                      /// RD: MAC and RDCP
                                      /// WR: WRCP
                                      {.level = "bankgroup", .preceding = {"RD", "RDA", "MAC", "RDCP", "RDMINCP"}, .following = {"RD", "RDA", "MAC", "RDCP", "RDMINCP"}, .latency = V("nCCDL")}, //MAINUDDIN
                                      ...
                                      /// WR: WRCP
                                      // "READ to PRECHARGE within the same bank group"
                                      {.level = "bankgroup", .preceding = {"RD", "RDCP", "RDMINCP", "MAC"}, .following = {"PRE", "PRE4"}, .latency = V("nRTP")},//MAINUDDIN
                                      // "Not based on the GDDR6 document"
                                      ...
                                      {.level = "bankgroup", .preceding = {"ACT4"}, .following = {"RDMINCP"}, .latency = V("nRCDRDMINCP")}, //MAINUDDIN
                                      ...
                                      {.level = "bank", .preceding = {"ACT"}, .following = {"RDMINCP"}, .latency = V("nRCDRDMINCP")}, //MAINUDDIN
...
#undef V
    ...
    void set_preqs() {
        ...
        m_preqs[m_levels["bank"]][m_commands["RDMINCP"]] = Lambdas::Preq::Bank::RequireRowOpen<GDDR6>; //MAINUDDIN
