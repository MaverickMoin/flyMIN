...
enum class Opcode {
    ...
    ISR_SYNC = 17,
    ISR_MIN_GB = 18, //MAINUDDIN: Perform Multistage Interconnectin
    MAX = 19
    //CHECK THIS OUT
...
public:
    static void init() {
        ...
        aim_opcode_to_str[Opcode::ISR_MIN_GB] = "ISR_MIN_GB"; //MAINUDDIN
        opcode_str_to_aim_ISR["ISR_MIN_GB"] = AiMISR(Opcode::ISR_MIN_GB,
                                                        {AiMISR::Field::opsize,
                                                         AiMISR::Field::channel_mask,
                                                         AiMISR::Field::bank_index,
                                                         AiMISR::Field::row_addr},
